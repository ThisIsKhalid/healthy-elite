...
const OurProduct = ({products}) => {
  ...
  return (
    <div className='h-full py-10'>        
      ...
      <ProductsModal isOpen={isOpen} setIsOpen={setIsOpen} productDetail={productDetail} />  
          ...
          <div className="">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 justify-items-center gap-5 lg:gap-10">
              <div className='flex flex-col items-center card rounded-xl md:w-80 lg:w-full justify-center cursor-pointer p-5 group transition-all duration-300 hover:scale-105'>
                <Image className="p-3 transition-all duration-300 group-hover:scale-110" width={200} height={200} src="https://i.ibb.co/YR66KR4/1605436989312.png" alt="" />
              ...
              <div className='flex flex-col items-center card rounded-xl md:w-80 lg:w-full justify-center cursor-pointer group transition-all duration-300 hover:scale-105'>
                <Image className="p-3 transition-all duration-300 group-hover:scale-110" width={200} height={200} src="https://i.ibb.co/yVVTyjF/ritch-50-ml1-1631424889466.webp" alt="" />
                <div className='text-center'>
                  <p className="text-xl z-10 font-semibold text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-violet-600">Prescription Medicine</p>
                </div>
              </div>
              <div className='flex flex-col items-center card rounded-xl md:w-80 lg:w-full justify-center cursor-pointer group transition-all duration-300 hover:scale-105'>
                <Image className="p-3 transition-all duration-300 group-hover:scale-110" width={200} height={200} src="https://i.ibb.co/zbNzDGS/ey-Jid-WNr-ZXQi-Oi-Jhcm9n-Z2-Ei-LCJr-ZXki-Oi-Jt-ZWRp-Y2lu-ZVwv-Mjdc-Lz-I3-Mz-Yz-LVNlbm9y-YS1-TYW5pd.jpg" alt="" />
                <div className='text-center'>
              ...
              <div className='flex flex-col items-center card rounded-xl md:w-80 lg:w-full justify-center cursor-pointer group transition-all duration-300 hover:scale-105'>
                <Image className="p-3 transition-all duration-300 group-hover:scale-110" width={200} height={200} src="https://i.ibb.co/ZzJ3KXJ/home9-png-39-1.png" alt="" />
                <div className='text-center'>
          ...
          <div className='w-full flex flex-col justify-start px-5 py-10 rounded-xl'>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-5 lg:gap-10 my-5 lg:my-10 ">
              ...
              items.slice(0,8)?.map(item =>
                    (
                        <div onClick={()=>openModal(item)} key={item._id} className='card flex flex-col items-center gap-2 bg-white p-5 group cursor-pointer'>
