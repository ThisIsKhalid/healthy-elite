            ...
            <div className="container mx-auto mt-5 grid grid-cols-1 gap-3">
                {
                    doctors.slice(0,3)?.map((doctor,i) => (
                        <div key={i} className="p-6 bg-white rounded-lg ">
                            ...
                            <div>
                                <img className=" rounded-full w-32 h-32"  src={doctor?.image} alt=""/>
                            </div>
                            ...
                            <p className="flex items-center justify-center gap-2">Availability <FaClock></FaClock> {doctor?.availability}</p>
                            </div>
                            <div>
